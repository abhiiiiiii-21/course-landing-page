...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative w-full py-8 lg:py-8 px-4 sm:px-6 lg:px-8 max-w-[1300px] mx-auto lg:border-x lg:border-gray-300/70">
          ...
          >
            ...
            <div className="flex flex-col justify-center">
              <div className="flex items-center gap-2 mb-0.5">
                  ...
                  <svg width="0" height="0" className="absolute pointer-events-none">
                    <defs>
                      <linearGradient id="partialStar" x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="66%" stopColor="#FF5B22" />
                        <stop offset="66%" stopColor="#E5E7EB" />
                      </linearGradient>
                    </defs>
                  </svg>
                  {[...Array(5)].map((_, i) => (
                    <svg 
                      ...
                      fill={i === 4 ? "url(#partialStar)" : "#FF5B22"} 
                      viewBox="0 0 20 20"
                    >
                ...
                <span className="text-[15px] sm:text-base font-semibold text-gray-700">93.2/100</span>
              </div>
