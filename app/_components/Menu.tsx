          ...
          <div className="flex-1 h-full flex items-center pl-3 sm:pl-4 pr-1 sm:pr-2">
            <Link href="/" className="cursor-pointer">
              <Image 
                ...
                width={160}
                height={40}
                className="h-[28px] sm:h-[40px] max-w-[110px] sm:max-w-[160px] object-contain" 
                style={{ width: 'auto' }}
              />
            </Link>
          </div>
