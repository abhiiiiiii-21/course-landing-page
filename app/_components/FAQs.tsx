    ...
    <section id="faqs" className="py-24 bg-transparent relative">
      <div className="max-w-[900px] mx-auto px-4 sm:px-6 relative">
        ...
        <div className="text-center mb-12 relative">
          ...
          <h2 className="text-[2.5rem] sm:text-[3.5rem] leading-[1.1] font-medium text-gray-900 tracking-tight relative inline-block">
            {faqsData.title}
            
            {/* Handwritten text & arrow */}
            <div className="absolute top-0 -right-8 sm:-right-60 hidden md:flex flex-col items-center pointer-events-none">
              <span 
        ...
        {/* FAQs Container */}
        <div className="bg-[#e6e6e6] rounded-[24px] sm:rounded-[32px] p-3 flex flex-col gap-2">
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="shrink-0 w-8 h-8 sm:w-9 sm:h-9 bg-black rounded-full flex items-center justify-center text-white transition-transform duration-300">
                    <motion.div
                      initial={false}
